web:       java $JAVA_OPTS -cp target/classes:target/dependency/* -Dcom.sun.media.imageio.disableCodecLib=true -javaagent:newrelic/newrelic.jar -Dnewrelic.config.file=newrelic.yml com.janknspank.server.NewsServer
