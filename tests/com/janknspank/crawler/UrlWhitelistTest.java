...
public class UrlWhitelistTest {
  ...
  public void testIsOkayNytimes() throws Exception {
    assertTrue(UrlWhitelist.isOkay("http://www.nytimes.com/"));
    ...
    assertTrue(UrlWhitelist.isOkay("http://publiceditor.blogs.nytimes.com/2014/12/22/sony-emails-free-speech-and-trying-a-little-f2f/"));
