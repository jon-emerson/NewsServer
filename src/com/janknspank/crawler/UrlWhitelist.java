  ...
  public static final CrawlInstructions CRAWL_INSTRUCTIONS = CrawlInstructions.newBuilder()
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/[0-9]{6,10}(.htm)?$"))
          .addRssUrl("http://www.abc.net.au/news/feed/45910/rss.xml") // "Top".
          .addRssUrl("http://www.abc.net.au/news/feed/51120/rss.xml") // "Just in".
          .addRssUrl("http://www.abc.net.au/news/feed/51892/rss.xml") // Business.
          .addRssUrl("http://www.abc.net.au/news/feed/52278/rss.xml") // World.
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addRssUrl("http://feeds.abcnews.com/abcnews/internationalheadlines")
          .addRssUrl("http://feeds.abcnews.com/abcnews/moneyheadlines")
          .addRssUrl("http://feeds.abcnews.com/abcnews/politicsheadlines")
          .addRssUrl("http://feeds.abcnews.com/abcnews/technologyheadlines")
          .addRssUrl("http://feeds.abcnews.com/abcnews/usheadlines")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/20[0-9]{2}[01][0-9][0-3][0-9]\\/"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/articles\\/20[0-9]{2}\\/1?[0-9]\\/[1-3]?[0-9]\\/.*\\.html$"))
          .addRssUrl("http://america.aljazeera.com/content/ajam/articles.rss")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/]+\\/$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/]+\\.ars$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/news\\/.*[0-9]{5,12}\\.html$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}[01][0-9][0-3][0-9]\\-[0-9]{3,10}\\.html$"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("-[0-9]{5,10}$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/story\\/20[0-9]{2}[01][0-9][0-3][0-9]\\-"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/newsbeat\\/[0-9]{7,10}$"))
          .addRssUrl("http://feeds.bbci.co.uk/news/business/rss.xml")
          .addRssUrl("http://feeds.bbci.co.uk/news/politics/rss.xml")
          .addRssUrl("http://feeds.bbci.co.uk/news/rss.xml")
          .addRssUrl("http://feeds.bbci.co.uk/news/science_and_environment/rss.xml")
          .addRssUrl("http://feeds.bbci.co.uk/news/technology/rss.xml")
          .addRssUrl("http://feeds.bbci.co.uk/news/world/rss.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/[^\\/]+\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/"))
          .addRssUrl("http://bdnews24.com/?widgetName=rssfeed&widgetId=1150&getXmlFeed=true")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/[a-z\\-\\_]+\\/20[0-9]{2}-[01][0-9]-[0-3][0-9](-|\\/).*(\\/|\\.html)$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/news\\/articles\\/(19|20)[0-9]{2}-[01][0-9]-[0-3][0-9]\\/[^\\/]+$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/bb\\/newsarchive\\/[a-zA-Z0-9_]{5,15}\\.html$"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addArticleUrl("http://www.bloomberg.com/news/articles/2014-11-14/obama-delivers-support-for-myanmar-opposition")
                  .addArticleUrl("http://www.bloomberg.com/news/articles/2015-02-14/obama-sends-labor-secretary-to-resolve-west-coast-ports-dispute")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/.*story\\.html$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/]+\\.html$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/\\.]+\\.html$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setSubdomain("finance.boston.com")
              .setPathRegex("\\/read\\/[0-9]{6,10}\\/[^\\/]+\\/$"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addPathBlacklist(PathBlacklist.newBuilder().setNeedle("/Breitbart-TV/"))
          .addPathBlacklist(PathBlacklist.newBuilder().setNeedle("/video/"))
          .addParagraphSelector("article > p")
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/[A-Za-z0-9\\-\\_]+\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/.*\\/$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/news\\/[^\\/]+\\-[^\\/]+\\-[^\\/]+\\/$"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\-20[0-9]{6}$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/article\\/20[0-9]{2}[01][0-9][0-3][0-9]\\/"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/apps\\/pbcs.dll\\/article"))
          .addRssUrl("http://www.buffalonews.com/section/rssGen?profileID=1109&profileName=Top%20Stories")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/news\\/.*\\-1\\.[0-9]{6,10}$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/\\.]+\\.html$"))
          .addRssUrl("http://www.cbc.ca/cmlink/rss-business")
          .addRssUrl("http://www.cbc.ca/cmlink/rss-technology")
          .addRssUrl("http://www.cbc.ca/cmlink/rss-topstories")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/news\\/(?!cbs-news-)[^\\/]+\\/$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/8301\\-[0-9_\\-]+\\/[^\\/]+\\/$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/[^\\/]+\\/[0-9a-f]+\\/([0-9]+\\/)?$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setSubdomain("markets.cbsnews.com")
              .setPathRegex("^\\/[^\\/]+\\/[0-9a-f]{12,19}\\/"))
          .addRssUrl("http://www.cbsnews.com/latest/rss/main")
          .addRssUrl("http://www.cbsnews.com/latest/rss/moneywatch")
          .addRssUrl("http://www.cbsnews.com/latest/rss/tech")
          .addRssUrl("http://www.cbsnews.com/latest/rss/us")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addArticleUrl("http://www.cbsnews.com/news/israeli-pm-benjamin-netanyahu-encourages-jews-to-flee-europe/")
                  .addArticleUrl("http://www.cbsnews.com/news/trucker-who-helped-save-sex-captive-in-virginia-ive-got-daughters/")
                  ...
                  .addNonArticleUrl("http://www.cbsnews.com/latest/tech/")
                  .addNonArticleUrl("http://www.cbsnews.com/media/top-health-stories-of-2014/")
                  .addNonArticleUrl("http://www.cbsnews.com/news/cbs-news-internship-program/")
                  .addNonArticleUrl("http://www.cbsnews.com/team/steve-kroft/"))
              .setUrlWhitelistChecks(UrlWhitelistChecks.newBuilder()
                  .addBadUrl("http://www.cbsnews.com/videos/where-selma-meets-hollywood/")))
          .build())
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/news\\/.*\\/[0-9]+\\.html$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/premier\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/.*\\/$"))
          .addRssUrl("http://www.channelnewsasia.com/starterkit/servlet/cna/rss/business.xml")
          .addRssUrl("http://www.channelnewsasia.com/starterkit/servlet/cna/rss/home.xml")
          .addRssUrl("http://www.channelnewsasia.com/starterkit/servlet/cna/rss/world.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("20[0-9]{2}[01][0-9][0-3][0-9]\\-(column|htmlstory|story|storygallery)\\.html$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex(",[0-9]{6,10}\\.(column|htmlstory|story|storygallery)$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setSubdomain("articles.chicagotribune.com")
              .setPathRegex("^\\/(19|20)[0-9]{2}-[01][0-9]-[0-3][0-9]\\/.*[0-9]{8}"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  .addArticleUrl("http://articles.chicagotribune.com/1998-09-18/business/9809180040_1_apartment-building-key-tenant")
                  .addArticleUrl("http://articles.chicagotribune.com/2006-09-18/news/0609180225_1_ambulance-police-custody-car-collision")
                  .addArticleUrl("http://articles.chicagotribune.com/2010-09-18/sports/ct-spt-0918-boxing-uic-pavilion--20100917_1_referee-middleweight-fight-andy-lee")
                  ...
                  .addArticleUrl("http://articles.chicagotribune.com/2014-04-15/business/ct-equifax-switches-sister-problem-0415-biz-20140415_1_equifax-credit-report-credit-file")
                  ...
                  .addNonArticleUrl("http://articles.chicagotribune.com/2010/sep/18")
                  .addNonArticleUrl("http://articles.chicagotribune.com/keyword/equifax")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/]+\\/$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("(\\-|\\/)[0-9]{7,10}\\.(php|html)$"))
          .addRssUrl("http://www.chron.com/rss/feed/AP-Technology-and-Science-266.php")
          .addRssUrl("http://www.chron.com/rss/feed/Business-287.php")
          .addRssUrl("http://www.chron.com/rss/feed/News-270.php")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[^\\/\\.]+\\.html$"))
          .addRssUrl("http://blog.cleveland.com/business_impact/atom.xml")
          .addRssUrl("http://blog.cleveland.com/business_impact/technology/atom.xml")
          .addRssUrl("http://blog.cleveland.com/realtimenews/atom.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addParagraphSelector("#article_body p")
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/id\\/[0-9]{9,11}(\\/[^\\/]*)?$"))
          .addRssUrl("http://www.cnbc.com/id/100003114/device/rss/rss.html") // Top.
          .addRssUrl("http://www.cnbc.com/id/10001147/device/rss/rss.html") // Business.
          .addRssUrl("http://www.cnbc.com/id/19854910/device/rss/rss.html") // Tech.
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/([A-Z]+\\/([A-Za-z]+\\/)?)?[01][0-9]\\/[0-3][0-9]\\/"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/SPECIALS\\/.*\\/index.html?$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setSubdomain("travel.cnn.com")
              .setPathRegex("\\-[0-9]{5,8}$"))
          .addRssUrl("http://rss.cnn.com/rss/cnn_tech.rss")
          .addRssUrl("http://rss.cnn.com/rss/cnn_topstories.rss")
          .addRssUrl("http://rss.cnn.com/rss/cnn_world.rss")
          .addRssUrl("http://rss.cnn.com/rss/money_latest.rss")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9](\\/[0-3][0-9])?\\/[^\\/\\.]+\\.php$"))
          .addRssUrl("http://curbed.com/atom.xml")
          .addRssUrl("http://la.curbed.com/atom.xml")
          .addRssUrl("http://ny.curbed.com/atom.xml")
          .addRssUrl("http://seattle.curbed.com/atom.xml")
          .addRssUrl("http://sf.curbed.com/atom.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/sites\\/[^\\/]+\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/"))
          .addRssUrl("http://www.forbes.com/business/feed/")
          .addRssUrl("http://www.forbes.com/most-popular/feed/")
          .addRssUrl("http://www.forbes.com/real-time/feed2/")
          .addRssUrl("http://www.forbes.com/technology/feed/")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/(.*\\-.*|[0-9]+)\\/$"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex(",[0-9]{6,10}\\.(column|htmlstory|story|storygallery)$"))
          .addRssUrl("http://www.latimes.com/business/rss2.0.xml")
          .addRssUrl("http://www.latimes.com/business/technology/rss2.0.xml")
          .addRssUrl("http://www.latimes.com/nation/rss2.0.xml")
          .addRssUrl("http://www.latimes.com/opinion/editorials/rss2.0.xml")
          .addRssUrl("http://www.latimes.com/rss2.0.xml")
          .addRssUrl("http://www.latimes.com/science/rss2.0.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/ci_[0-9]{7,10}(\\/.*)?$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/[^\\/]+\\/$"))
          .addRssUrl("http://feeds.mercurynews.com/mngi/rss/CustomRssServlet/568/200735.xml")
          .addRssUrl("http://feeds.mercurynews.com/mngi/rss/CustomRssServlet/568/200737.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  .addArticleUrl("http://realestate.mercurynews.com/2015/02/06/facebook-purchases-56-acres-in-menlo-park/")
                  .addArticleUrl("http://realestate.mercurynews.com/2015/02/15/who-sold-what-published-feb-14-2015/")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/(aponline\\/)?(19|20)[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/.*\\-.*\\-.*(\\/|\\.html)$"))
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/Business.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/Economy.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/HomePage.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/InternationalHome.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/PersonalTech.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/Politics.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/Science.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/SmallBusiness.xml")
          .addRssUrl("http://rss.nytimes.com/services/xml/rss/nyt/Technology.xml")
          .addRssUrl("http://www.nytimes.com/services/xml/rss/nyt/JobMarket.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/[^\\/]+\\/$"))
          .addRssUrl("http://recode.net/category/general/feed/")
          .addRssUrl("http://recode.net/feed/")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/article.*(\\-|\\/)[0-9]{7,10}\\.php$"))
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/[0-9a-z\\-]+\\/20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/[^\\/]+\\/$"))
          .addRssUrl("http://www.sfgate.com/default/feed/City-Insider-Blog-573.php")
          .addRssUrl("http://www.sfgate.com/rss/feed/Page-One-News-593.php")
          .addRssUrl("http://www.sfgate.com/rss/feed/Tech-News-449.php")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/(articles|blogs)\\/.*\\/20[0-9]{2}\\/[01][0-9]\\/.*\\.html$"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addParagraphSelector("article > div > p")
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("\\/20[0-9]{2}\\/(jan|feb|mar|apr|may|jun|jul|aug|sep|nov|dec)\\/[0-3][0-9]\\/"))
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addParagraphSelector(".entry-content p")
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/([a-z\\_\\-]+\\/)?20[0-9]{2}\\/[01][0-9]\\/[0-3][0-9]\\/[^\\/]+\\/$"))
          .addRssUrl("http://thenextweb.com/feed/")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  .addArticleUrl("http://thenextweb.com/2009/02/14/microsoft-open-retail-stores/")
                  .addArticleUrl("http://thenextweb.com/apple/2015/02/13/apple-pay-will-available-us-government-transactions-fall/")
                  .addArticleUrl("http://thenextweb.com/apps/2015/02/13/darkroom-ios-advanced-photo-app-youve-always-wanted/")
                  .addArticleUrl("http://thenextweb.com/column/2015/02/14/walking-mountain-one-step-time/")
                  .addArticleUrl("http://thenextweb.com/creativity/2015/02/14/genius-timehops-valentines-day-warning-screen/")
                  .addArticleUrl("http://thenextweb.com/facebook/2015/02/13/facebook-updates-groups-app-ios-new-admin-abilities/")
                  .addArticleUrl("http://thenextweb.com/lifehacks/2015/02/14/modern-mentor-guide-courting-influencers/")
                  .addArticleUrl("http://thenextweb.com/offers/2015/02/14/top-tnw-deals-week-3/")
                  .addArticleUrl("http://thenextweb.com/opinion/2015/02/13/wow-slack-got-big/")
                  .addArticleUrl("http://thenextweb.com/socialmedia/2015/02/14/complete-beginners-guide-social-media-benchmarks/")
                  .addArticleUrl("http://thenextweb.com/twitter/2015/02/12/twitter-testing-multi-photo-display-feed/")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .addParagraphSelector("article p")
          .addArticleUrlPattern(ArticleUrlPattern.newBuilder()
              .setPathRegex("^\\/([a-z\\_\\-]+\\/)?20[0-9]{2}\\/1?[0-9]\\/[1-3]?[0-9]\\/[0-9]{7,9}\\/"))
          .addRssUrl("http://www.theverge.com/mobile/rss/index.xml")
          .addRssUrl("http://www.theverge.com/rss/index.xml")
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
