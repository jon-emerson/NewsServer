      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addNonArticleUrl("http://www.slate.com/articles/briefing/slate_fare/2011/12/commenting_on_slate_frequently_asked_questions.html")
                  .addNonArticleUrl("http://www.slate.com/articles/news_and_politics/slate_fare/2006/08/about_us.html")))
          .build())
      .addContentSite(ContentSite.newBuilder()
