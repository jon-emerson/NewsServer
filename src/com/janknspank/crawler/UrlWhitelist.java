...
public class UrlWhitelist {
  ...
  public static final CrawlInstructions CRAWL_INSTRUCTIONS = CrawlInstructions.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addArticleUrl("http://arstechnica.com/archive/news/1032300246.html")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addNonArticleUrl("http://www.breitbart.com")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  .addArticleUrl("http://www.businessweek.com/articles/2013-05-14/harvard-business-school-boat-parody-sinks")
                  .addArticleUrl("http://www.businessweek.com/news/2011-10-08/bofa-hands-sallie-krawcheck-6-million-severance-after-ouster.html")
                  .addArticleUrl("http://www.businessweek.com/the_thread/brandnewday/archives/2006/10/is_the_champagne_in_the_jay-z_video_for_real_its_complicated.html")
                  .addNonArticleUrl("http://investing.businessweek.com/research/company/overview/overview.asp")
                  .addNonArticleUrl("http://investing.businessweek.com/research/markets/detail/marketdetail.asp?marketCode=CCMP%3AIND")
                  .addNonArticleUrl("http://www.businessweek.com")
                  .addNonArticleUrl("http://www.businessweek.com/authors/1062-francesca-di-meglio")
                  .addNonArticleUrl("http://www.businessweek.com/authors/1416-john-tozzi/page/117")
                  .addNonArticleUrl("http://www.businessweek.com/features/design-issue-2014/")))
          .build())
      .addContentSite(ContentSite.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addNonArticleUrl("http://www.cleveland.com")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addArticleUrl("http://us.cnn.com/2014/03/02/africa/gallery/cnnee-vida-oscar-pistorius/index.html")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addNonArticleUrl("http://mashable.com/")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addArticleUrl("http://www.money.cnn.com/gallery/investing/2013/04/28/worlds-top-stock-markets/index.html")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addNonArticleUrl("http://www.redherring.com/events/red-herring-global/")
                  .addNonArticleUrl("http://www.redherring.com/events/top-100/testimonials/")))
          .build())
      .addContentSite(ContentSite.newBuilder()
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  .addNonArticleUrl("http://www.slate.com/articles/podcasts/working/2014/12/google_software_engineer_nina_kang_talks_about_the_differences_between_writing.html")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  ...
                  .addNonArticleUrl("http://techcrunch.com")
      ...
      .addContentSite(ContentSite.newBuilder()
          ...
          .setTestInstructions(TestInstructions.newBuilder()
              .setArticleUrlDetectorChecks(ArticleUrlDetectorChecks.newBuilder()
                  .addArticleUrl("http://blog.washingtonpost.com/capitalweathergang/2008/01/about_this_blog.html")
