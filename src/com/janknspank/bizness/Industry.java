...
public enum Industry {
  ...
  BIOTECHNOLOGY(12, FeatureId.LIFE_SCIENCES, "gov hlth tech",
      "Biotechnology"),
  MEDICAL_PRACTICE(13, FeatureId.MEDICINE, "hlth",
      "Medical Practice"),
  HOSPITAL_AND_HEALTH_CARE(14, FeatureId.MEDICINE, "hlth",
      "Hospital & Health Care"),
  PHARMACEUTICALS(15, FeatureId.LIFE_SCIENCES, "hlth tech",
      "Pharmaceuticals"),
  ...
  SPORTING_GOODS(20, FeatureId.APPAREL_AND_FASHION, "good rec",
      "Sporting Goods"),
  TOBACCO(21, FeatureId.CONSUMER_GOODS, "good",
      "Tobacco"),
  ...
  FOOD_AND_BEVERAGES(34, FeatureId.RESTAURANTS, "rec serv",
      "Food & Beverages"),
  MOTION_PICTURES_AND_FILM(35, FeatureId.ANIMATION, "art med rec",
      "Motion Pictures and Film"),
  BROADCAST_MEDIA(36, FeatureId.MANAGEMENT, "med rec",
      "Broadcast Media"),
  ...
  CHEMICALS(54, FeatureId.CHEMICALS, "man",
      "Chemicals"),
  MACHINERY(55, FeatureId.HARDWARE_AND_ELECTRONICS, "man",
      "Machinery"),
  ...
  PACKAGE_FREIGHT_DELIVERY(87, FeatureId.MANAGEMENT, "serv tran",
  ...
  CONSUMER_SERVICES(91, FeatureId.CONSUMER_GOODS, "org serv",
      "Consumer Services"),
  TRANSPORTATION_TRUCKING_RAILROAD(92, FeatureId.MANAGEMENT, "tran",
      "Transportation/Trucking/Railroad"),
  WAREHOUSING(93, FeatureId.MANAGEMENT, "tran",
      "Warehousing"),
  AIRLINES_AVIATION(94, FeatureId.AVIATION, "man tech tran",
      "Airlines/Aviation"),
  MARITIME(95, FeatureId.MANAGEMENT, "tran",
      "Maritime"),
  ...
  NANOTECHNOLOGY(114, FeatureId.HARDWARE_AND_ELECTRONICS, "gov man tech",
      "Nanotechnology"),
  MUSIC(115, FeatureId.ARTS, "art rec",
      "Music"),
  LOGISTICS_AND_SUPPLY_CHAIN(116, FeatureId.MANAGEMENT, "corp tran",
      "Logistics and Supply Chain"),
  PLASTICS(117, FeatureId.CHEMICALS, "man",
      "Plastics"),
  ...
  MEDIA_PRODUCTION(126, FeatureId.ARTS, "med rec",
      "Media Production"),
  ...
  E_LEARNING(132, FeatureId.EDUCATION, "edu org",
      "E-Learning"),
  WHOLESALE(133, FeatureId.CONSUMER_GOODS, "good",
      "Wholesale"),
  IMPORT_AND_EXPORT(134, FeatureId.MANAGEMENT, "corp good tran",
      "Import and Export"),
  MECHANICAL_OR_INDUSTRIAL_ENGINEERING(135, FeatureId.HARDWARE_AND_ELECTRONICS,
  ...
  HUMAN_RESOURCES(137, FeatureId.HUMAN_RESOURCES, "corp",
      "Human Resources"),
  BUSINESS_SUPPLIES_AND_EQUIPMENT(138, FeatureId.MANAGEMENT, "corp man",
  ...
  INDUSTRIAL_AUTOMATION(147, FeatureId.CONSTRUCTION, "cons man",
