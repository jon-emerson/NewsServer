...
public enum Industry {
  ...
  INTERNET(6, FeatureId.INTERNET, "tech",
      "Internet"),
  SEMICONDUCTORS(7, FeatureId.COMPUTER_HARDWARE, "tech",
      "Semiconductors"),
  ...
  FOOD_AND_BEVERAGES(34, FeatureId.RESTAURANTS, "rec serv",
      "Food & Beverages"),
  MOTION_PICTURES_AND_FILM(35, FeatureId.MEDIA, "art med rec",
      "Motion Pictures and Film"),
  BROADCAST_MEDIA(36, FeatureId.MEDIA, "med rec",
      "Broadcast Media"),
  ...
  PERFORMING_ARTS(39, FeatureId.ARTS, "art med rec",
      "Performing Arts"),
  RECREATIONAL_FACILITIES_AND_SERVICES(40, FeatureId.HEALTH_WELLNESS_AND_FITNESS,
      "rec serv", "Recreational Facilities and Services"),
  BANKING(41, FeatureId.FINANCIAL_SERVICES, "fin",
      "Banking"),
  INSURANCE(42, FeatureId.FINANCIAL_SERVICES, "fin",
      "Insurance"),
  FINANCIAL_SERVICES(43, FeatureId.FINANCIAL_SERVICES, "fin",
      "Financial Services"),
  REAL_ESTATE(44, FeatureId.REAL_ESTATE, "cons fin good",
      "Real Estate"),
  INVESTMENT_BANKING(45, FeatureId.FINANCIAL_SERVICES, "fin",
      "Investment Banking"),
  INVESTMENT_MANAGEMENT(46, FeatureId.FINANCIAL_SERVICES, "fin",
  ...
  CONSUMER_SERVICES(91, FeatureId.FINANCIAL_SERVICES, "org serv",
      "Consumer Services"),
  ...
  ONLINE_MEDIA(113, FeatureId.MEDIA, "med",
      "Online Media"),
  NANOTECHNOLOGY(114, FeatureId.COMPUTER_HARDWARE, "gov man tech",
      "Nanotechnology"),
  ...
  ALTERNATIVE_MEDICINE(125, FeatureId.HEALTH_WELLNESS_AND_FITNESS, "hlth",
      "Alternative Medicine"),
  MEDIA_PRODUCTION(126, FeatureId.MEDIA, "med rec",
      "Media Production"),
  ANIMATION(127, FeatureId.MEDIA, "art med",
      "Animation"),
  COMMERCIAL_REAL_ESTATE(128, FeatureId.REAL_ESTATE, "cons corp fin",
      "Commercial Real Estate"),
  CAPITAL_MARKETS(129, FeatureId.FINANCIAL_SERVICES, "fin",
      "Capital Markets"),
